...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 21526 or testnet: 121526)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21527 or testnet: 121527)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeArtaxAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    /* Denominations
       ...
       For example:
       1Artax+1000 == (.1Artax+100)*10
       10Artax+10000 == (1Artax+1000)*10
    */
