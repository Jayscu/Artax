#############################################################################
# Makefile for building: Artax-qt
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  artax.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile artax.pro
#############################################################################
...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -Isrc -Isrc/json -Isrc/qt -Isrc/qt/plugins/mrichtexteditor -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/include/qt5 -I/usr/include/qt5/QtPrintSupport -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtDBus -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -lminiupnpc /home/compiler/FIX/artax/src/leveldb/libleveldb.a /home/compiler/FIX/artax/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -L/usr/lib/i386-linux-gnu -lQt5Widgets -lQt5DBus -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
/home/compiler/FIX/artax/src/leveldb/libleveldb.a: FORCE
	cd /home/compiler/FIX/artax/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/compiler/FIX/artax/build/build.h: FORCE
	cd /home/compiler/FIX/artax; /bin/sh share/genbuild.sh /home/compiler/FIX/artax/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/artax-96.png \
		src/qt/res/icons/artax-96.png \
		src/qt/res/icons/staking_off.png \
		src/qt/res/icons/artax-16.png \
