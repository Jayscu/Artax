...
public:
    ...
    void retranslateUi(QDialog *AddEditAdrenalineNode)
    {
        ...
        label_3->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter an Alias (Nickname) for your Masternodes Node and its address (either clearnet IP and port or Tor onion address and port).  The address should be in the format 201.456.789.123:9999 or Xkbxysafxjkhasdf.onion:9999.  A Masternode private key and a collateral address will both be automatically generated for you.  You must send exactly 3000 ARTX to the collateral address.</p></body></html>", 0));
