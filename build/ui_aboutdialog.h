...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Artax", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Artax</b> version", 0));
...
"Copyright \302\251 2018 The Artax Development Team", 0));
